...
const MainCardAvenger = () => {
    ...
    useEffect(() => {
        const fetchMovies = async () => {
            try {
                const response = await axios.get('https://www.omdbapi.com/?apikey=48f5e168&s=avenger');
    ...
    return (
        <Container className="mt-5">  
            <h1 className="text-start mb-4">Avenger</h1>
            <Carousel>
...
export default MainCardAvenger;
