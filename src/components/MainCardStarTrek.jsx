...
const MainCardStarTrek = () => {
    ...
    useEffect(() => {
        const fetchMovies = async () => {
            try {
                const response = await axios.get('https://www.omdbapi.com/?apikey=48f5e168&s=star%20trek');
    ...
    return (
        <Container className="mt-5">
            <h1 className="text-start mb-4">Star Trek</h1>
            <Carousel>
...
export default MainCardStarTrek;
